...
\\
{\tt Load-Add-Store}: loads value from source bitfield, adds operand, and stores result in destination bitfield:
can optionally move or destroy the opaque S-expression storage.
\\
